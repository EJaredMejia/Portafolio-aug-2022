...
const AboutMe = () => {
  return (
    <section className="w-[80%] mx-auto max-w-[800px]">
      <h3 id="aboutMe" className="font-semibold mt-6 text-2xl border-b-4 w-fit border-gray-400">About Me</h3>
      <h4 className="text-xl my-5 tracking-widest font-semibold">WEB DEVELOPER</h4>
      <p className="text-lg text-gray-700">
        I am a web developer who loves to learn more about programming every
