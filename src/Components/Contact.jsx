...
const Contact = () => {
  ...
  return (
    <section id="contactMe" className="mt-5 pt-[3rem] bg-gray-100 pb-[3rem]">
      ...
      <form onSubmit={()=>alert("Email sent successfully")} action="https://formsubmit.co/efab2d506f25436bd2dfdc533675b986" method="POST" className="grid mx-auto gap-4 mt-5 w-[90%] max-w-[1300px] md:grid-cols-2">
        {/*  HoneyPot  */}
