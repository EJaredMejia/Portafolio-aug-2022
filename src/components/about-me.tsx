...
const AboutMe = () => {
  return (
    <section className="w-[80%] mx-auto max-w-200">
      <h3
        id="aboutMe"
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="mb-6 btn-animation inline-block rounded-full text-lg border-2 border-black mt-6 py-2 px-5 go-to-btn hover:text-white"
      >
        Download CV
      </a>
    </section>
